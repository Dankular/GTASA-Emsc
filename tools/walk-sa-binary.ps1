...
$report=[ordered]@{
 ...
 functionCount=@($functions).Count; symbolCount=@($symbols).Count; functions=@($functions|Select-Object name,offset,size,nbbs,edges,calltype,signature); classifiedBoundaries=$classified
